...
public class SkillOrganizer extends BLCMMModelPlugin {

    private SkillOrganizerPanel panel;
//Use this if you want your plugin to export to the currently opened file in BLCMM
//public class MyPlugin extends BLCMMFilePlugin {//Use this if you want your plugin to export to a file

    public SkillOrganizer() {
        super(true, true, "LightChaosman", "1.0");
    ...
    public JPanel getGUI() {
        return panel = new SkillOrganizerPanel();
    }
    ...
    public String[] getRequiredDataClasses() {
        return new String[]{"SkillDefinition"};
    }
